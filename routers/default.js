...
router.get('/tanque2', (req, res) => {
  getData(conexion,'tanque2',result => {
    res.render('charts/graficos', {
      tituloHead:'PP UNLa',
      titulo : 'Dashboard PP UNLa',
      data : result
...
router.get('/tanque3', (req, res) => {
  getData(conexion,'tanque3',result => {
    res.render('charts/graficos', {
      tituloHead:'PP UNLa',
      titulo : 'Dashboard PP UNLa',
      data : result
...
router.get('/tanque4', (req, res) => {
  getData(conexion,'tanque4',result => {
    res.render('charts/graficos', {
      tituloHead:'PP UNLa',
      titulo : 'Dashboard PP UNLa',
      data : result
...
router.get('/tanque5', (req, res) => {
  getData(conexion,'tanque5',result => {
    res.render('charts/graficos', {
      tituloHead:'PP UNLa',
      titulo : 'Dashboard PP UNLa',
      data : result
...
router.get('/tanque6', (req, res) => {
  getData(conexion,'tanque6',result => {
    res.render('charts/graficos', {
      tituloHead:'PP UNLa',
      titulo : 'Dashboard PP UNLa',
      data : result
